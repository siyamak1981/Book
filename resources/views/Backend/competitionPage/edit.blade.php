...
<div class="content-page">
  ...
  <div class="content">
      ...
      <div class="row">
        ...
        <form role="form" action="{{ route('competition_page.update', $competitionpage->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
            {{ method_field('PATCH') }}
          <div class="card-box">
            <div class="col-sm-12">
              <div class="col-md-3">
                ...
                data-default-file="{{asset('Backend/images/gallery/1.jpg') }}"  value="{{ $competitionpage->image_one }}"/>
              <img src=" {{ URL::to($competitionpage->image_one) }} " style="width: 70px; height:70px;">
              </div><!-- end col -->
              ...
              <div class="col-md-3">
                ...
                data-default-file="{{ asset('Backend/images/gallery/1.jpg') }}" value="{{ $competitionpage->image_one }}"/>
              <img src=" {{ URL::to($competitionpage->image_two) }} " style="width: 70px; height:70px;">
              </div><!-- end col -->

              <div class="col-md-3">
                <h4 class="header-title m-t-0 m-b-30">نمونه سوم</h4>
                <input type="file" class="dropify" name="image_three" 
                data-default-file="{{ asset('Backend/images/gallery/1.jpg') }}" value="{{ $competitionpage->image_three }}"/>
              <img src=" {{ URL::to($competitionpage->image_three) }} " style="width: 70px; height:70px;">
              </div><!-- end col -->
              <div class="col-md-3">
                <h4 class="header-title m-t-0 m-b-30">نمونه چهارم</h4>
                <input type="file" class="dropify" name="image_four" 
                data-default-file="{{ asset('Backend/images/gallery/1.jpg') }}" value="{{ $competitionpage->image_four }}"/>
              <img src=" {{ URL::to($competitionpage->image_four) }} " style="width: 70px; height:70px;">
              </div><!-- end col -->
              ...
              <div class="col-lg-6 m-t-30">
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="title1" class="form-control" value="{{ $competitionpage->title1 }}"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="summary1" class="form-control" value="{{ $competitionpage->summary1 }}"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label"> سر تیتر</label>
                  <div class="col-md-10">
                    <input type="text" name="title2" class="form-control" value="{{ $competitionpage->title2 }}"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label">خلاصه </label>
                  <div class="col-md-10">
                    <input type="text" name="summary2" class="form-control" value="{{ $competitionpage->summary2 }}"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label"> سر تیتر</label>
                  <div class="col-md-10">
                    <input type="text" name="title3" class="form-control" value="{{ $competitionpage->title3 }}"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label">خلاصه </label>
                  <div class="col-md-10">
                    <input type="text" name="summary3" class="form-control" value="{{ $competitionpage->summary3 }}"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label"> سر تیتر</label>
                  <div class="col-md-10">
                    <input type="text" name="title4" class="form-control" value="{{ $competitionpage->title4 }}"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label">خلاصه </label>
                  <div class="col-md-10">
                    <input type="text" name="summary4" class="form-control" value="{{ $competitionpage->summary4 }}"/>
                  </div>
                </div>
              ...
              <div class="form-group">
                  <label class="col-md-2 control-label"> سر تیتر</label>
                  <div class="col-md-10">
                    <input type="text" name="title5" class="form-control" value="{{ $competitionpage->title5 }}"/>
                  </div>
                </div>
