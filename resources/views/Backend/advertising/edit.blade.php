    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <form role="form" action="{{ route('advertising.update',$adv->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
            {{ method_field('PATCH') }}
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <img src="{{Storage::disk('local')->url('advertising/'.$adv->image)}}" style="width: 70px; height:70px;margin-bottom:50px">
                  ...
                  <div class="col-sm-6">
                    <div class="checkbox checkbox-pink m-t-30">
                      <input id="checkbox1" type="checkbox" name="status" data-parsley-multiple="groups" 
                      data-parsley-mincheck="2" 
                      data-parsley-id="69" value="1" @if ($adv->status == 1)
                        {{'checked'}}
                      @endif>
                      <label for="checkbox1"> انتشار </label>
                            ...
                            <div class="form-group text-right m-r-5">
                                ...
                                <a type="submit" href="{{ route('advertising.index') }}" class="btn btn-default waves-effect waves-light m-l-5">
                                    برگشت
                                </a>
                            </div>
                </form>
