    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <form role="form" action="{{ route('advertising.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <div class="col-lg-6 m-t-30">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="alt" class="form-control" placeholder="توضیح تصویر">
                                    </div>
                                </div>
                            </div><!-- end col -->
