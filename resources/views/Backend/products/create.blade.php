          ...
          <form role="form" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="number" name="discount" id="discount" class="form-control" placeholder="Discount" aria-describedby="helpId">
            </div>

            <div class="form-group">
                <label for="wigth">Code</label>
                <input type="text" name="product_code" id="product_code" class="form-control" placeholder="Product Code" aria-describedby="helpId">
            </div>
              </div>
