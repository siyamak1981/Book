...
<div class="content-page">
  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <form role="form" action="{{ route('team.update', $team->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
        <div class="card-box">
          <div class="col-sm-12">
            <div class="col-md-3">
              ...
              <input type="file" class="dropify" name="image" data-default-file="{{asset('Backend/images/gallery/1.jpg') }}" value="{{ $team->image }}" />
              <img src=" {{ URL::to($team->image) }} " style="width: 70px; height:70px;">
            </div><!-- end col -->
          ...
          <div class="form-group text-right m-r-5">
            ...
            <a type="submit" href="{{ route('team.index') }}" class="btn btn-default waves-effect waves-light m-l-5">
              برگشت
            </a>
          </div>
      </form>
