...
<div class="content-page">
  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <form role="form" action="{{ route('team.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="card-box">
          <div class="col-sm-12">
            <div class="col-md-4">
              <h4 class="header-title m-t-0 m-b-30">نمونه اول</h4>
              <input type="file" class="dropify" name="image" data-default-file="{{asset('Backend/images/gallery/1.jpg') }}" />
            </div><!-- end col -->
            ...
            <div class="col-lg-6 m-t-30">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" name="role" class="form-control" placeholder="یک متن نومنه">
                </div>
