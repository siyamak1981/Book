  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        ...
        <form role="form" action="{{ route('festival.update',$festival->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
          <div class="col-sm-12">
            <div class="card-box">
              ...
              <img src="{{Storage::disk('local')->url('festival/'.$festival->image)}}" style="width: 70px; height:70px;margin-bottom:50px">
              ...
              <div class="col-lg-6 m-t-30">
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="title" class="form-control" value="{{ $festival->title }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 m-t-10">
                    <input type="text" class="form-control" placeholder="متن درون نوشته" name="subtitle"  value="{{ $festival->subtitle }}">
                  </div>
                </div>
              ...
              <div class="col-lg-6 m-t-30">
                <div class="form-group">
                  ...
                  <div class="col-sm-10 m-t-10">
                    <input type="text" class="form-control" name="slug" placeholder="Slug" value="{{ $festival->slug }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="checkbox checkbox-pink m-t-30">
                      ...
                      data-parsley-id="69" value="1" @if ($festival->status == 1)
                        {{'checked'}}
                      @endif>
              ...
              <div class="col-lg-12">
                <div class="card-box">
                  <textarea id="elm1" name="body" value="{{ $festival->body }}"></textarea>
                </div>
              </div>
              <div class="form-group text-right m-r-5">
                ...
                <a type="submit" href="{{ route('festival.index') }}" class="btn btn-default waves-effect waves-light m-l-5">
                  برگشت
                </a>
              </div>
        </form>
